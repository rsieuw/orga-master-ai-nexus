...
const BottomNavigation: React.FC<BottomNavigationProps> = ({ openNewTaskModal }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 bg-card/80 backdrop-blur-sm border-t border-border shadow-md flex justify-around items-center md:hidden z-30">
      {navItems.map((item) => {
